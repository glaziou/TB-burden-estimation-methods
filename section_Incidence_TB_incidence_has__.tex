...
\begin{itemize}
\item Case notification data combined with expert opinion about case detection gaps;
\item Results from national TB prevalence surveys;
\item Notifications in high-income countries adjusted by a standard factor to account for under-reporting and under-diagnosis;
\item Results from inventory/capture recapture studies.
\end{itemize}
