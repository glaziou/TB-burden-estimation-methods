...
The incidence rate obtained using method $i$ is assumed distributed Beta with shape and scale parameters $a_i + 1$ and $b_i + 1$, respectively, and determined using the method of moments based on equation \ref{eq:betamoments}: $I_i \sim B(a_i + 1. b_i + 1)$ so that 
