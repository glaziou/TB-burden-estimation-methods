...
The uncertainty related to the adjustment was estimated with standard deviation $\hat{\sigma} = d/4 [1/c(1-g) -1]$. The uncertainty calculation does not account for miscoding, such as HIV deaths miscoded as deaths due to TB. 
