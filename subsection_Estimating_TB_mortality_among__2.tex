...
Among the countries for which VR data could be used (see Figure \ref{fig:vr}), there were 2361 country-year data points 1990–2014, after 13 outlier data points from systems with very low coverage ($<20\%$) or very high proportion of ill-defined causes ($>50\%$) were excluded for analytical purposes. The median number of data points per country was 21 (IQR 15 - 23). 
