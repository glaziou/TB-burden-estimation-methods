...
The uncertainty related to the adjustment was estimated with standard deviation $SD=\frac{d}{4 c (1-g) -1}$. The uncertainty calculation does not account for miscoding, such as HIV deaths miscoded as deaths due to TB. 
